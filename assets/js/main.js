...
// Filter states in the search box
function filterStates() {
    let input = document.getElementById("stateSearch").value.toUpperCase();
    let links = document.querySelectorAll(".state-grid a");

    links.forEach(link => {
        let txtValue = link.textContent || link.innerText;
        link.style.display = txtValue.toUpperCase().indexOf(input) > -1 ? "" : "none";
    });
}
